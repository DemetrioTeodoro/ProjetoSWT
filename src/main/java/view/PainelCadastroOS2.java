...
public class PainelCadastroOS2 extends JPanel {
	private String cep;
	...
	public PainelCadastroOS2() {
		...
		dateInicial.getComponentToggleCalendarButton().setIcon(new ImageIcon(PainelCadastroOS2.class.getResource("/icones/calendar-icon.png")));

		DatePicker datePrevistaFinal = new DatePicker();
		datePrevistaFinal.getComponentToggleCalendarButton().setIcon(new ImageIcon(PainelCadastroOS2.class.getResource("/icones/calendar-icon.png")));
		...
		btnAdd.setIcon(new ImageIcon(PainelCadastroOS2.class.getResource("/icones/Button-Add-icon.png")));
