...
public class TelaCadastroProfissional01 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCadastroProfissional01 frame = new TelaCadastroProfissional01();
	 ...
	 * Create the frame.
	 */
	public TelaCadastroProfissional01() {
